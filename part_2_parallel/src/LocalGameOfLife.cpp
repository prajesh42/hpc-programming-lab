...
LocalGameOfLife::LocalGameOfLife(int local_rows, int local_cols, MPI_Comm cart_comm, int halo_size)
    ...
    //
    // Implement correct neighbor ranks for each process and do not hardcode it like in the example! Use
    // MPI_Cart_shift (more convenient) or calculate them manually using dimensions and ranks.
...
void LocalGameOfLife::exchange_halos() {
    ...
    // This is the main challenge of the project! You must implement the halo exchange logic using MPI
    // Here are some hints:
